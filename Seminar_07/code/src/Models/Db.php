...
class Db
{
    ...
    private function __construct()
    {
        try {
            ...
            $this->checkAndCreateTokensTable();
    ...
    /**
     * Проверяет наличие таблицы 'user_tokens' и, если она отсутствует, создает её.
     */
    private function checkAndCreateTokensTable(): void
    {
        $result = $this->query("SHOW TABLES LIKE 'user_tokens'");
